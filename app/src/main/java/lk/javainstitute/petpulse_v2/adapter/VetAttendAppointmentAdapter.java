...
import lk.javainstitute.petpulse_v2.vet.Vet_Attend_Appointments_Full_Details_Activity;

public class VetAttendAppointmentAdapter extends RecyclerView.Adapter<VetAttendAppointmentAdapter.ViewHolder> {
    ...
    public VetAttendAppointmentAdapter(ArrayList<Appointment> appointments, Context context) {
    ...
    @NonNull
    @Override
    public VetAttendAppointmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View inflate = inflater.inflate(R.layout.vet_appoinments_row, parent, false);
        return new VetAttendAppointmentAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull VetAttendAppointmentAdapter.ViewHolder holder, int position) {
        ...
        holder.btnViewApp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (appointment != null) {
                    ...
                    Intent intent = new Intent(context, Vet_Attend_Appointments_Full_Details_Activity.class);
